...
export function Post({author, publishedAt, content}: PostProps){
    ...
    function deleteComment(commentToDelete: string){
        ...
        const commentsWithoutDeleleOne = comments.filter(comment => {
            return comment != commentToDelete;
        })

        setComments(commentsWithoutDeleleOne);
    }
...
return(
    ...
    <article className={styles.post}>
        <header>
            ...
            <time title='11 de mMaio ás 08:13h' dateTime={publishedAt.toISOString()}>               
